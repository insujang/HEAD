set C_TypeInfoList {{ 
"adder" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }],[],""], 
"0": [ "stream<ap_item>", {"hls_type": {"stream": [[[[],"1"]],"2"]}}], 
"1": [ "ap_item", {"struct": [[],[],[{ "data": [[],  {"scalar": "int"}]},{ "last": [[], "3"]}],""]}], 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"adder","role":"start","value":"0","valid_bit":"0"},{"name":"adder","role":"continue","value":"0","valid_bit":"4"},{"name":"adder","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"adder","role":"start","value":"0","valid_bit":"0"},{"name":"adder","role":"done","value":"0","valid_bit":"1"},{"name":"adder","role":"idle","value":"0","valid_bit":"2"},{"name":"adder","role":"ready","value":"0","valid_bit":"3"},{"name":"adder","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "inStream_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "inStream_V_data", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "adder", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "inStream_V_data", "Type" : "Axis", "Direction" : "I", "BlockSignal" : [
			{"Name" : "inStream_TDATA_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}, 
		{"Name" : "inStream_V_last_V", "Type" : "Axis", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "outStream_V_data", "Type" : "Axis", "Direction" : "O", "BlockSignal" : [
			{"Name" : "outStream_TDATA_blk_n", "Type" : "RtlSignal"}], "SubConnect" : []}, 
		{"Name" : "outStream_V_last_V", "Type" : "Axis", "Direction" : "O", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.adder_AXILiteS_s_axi_U", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	inStream_V_data { axis {  { inStream_TDATA in_data 0 32 }  { inStream_TVALID in_vld 0 1 } } }
