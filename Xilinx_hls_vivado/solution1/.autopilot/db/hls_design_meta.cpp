...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStream_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("inStream_TLAST", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("outStream_TDATA", 32, hls_out, 2, "axis", "out_data", 1),
	Port_Property("outStream_TVALID", 1, hls_out, 3, "axis", "out_vld", 1),
	Port_Property("outStream_TREADY", 1, hls_in, 3, "axis", "out_acc", 1),
	Port_Property("outStream_TLAST", 1, hls_out, 3, "axis", "out_data", 1),
