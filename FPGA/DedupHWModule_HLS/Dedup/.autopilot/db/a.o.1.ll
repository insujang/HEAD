; ModuleID = '/home/insujang/cs710/HEAD/FPGA/DedupHWModule_HLS/Dedup/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"class.hls::stream.24" = type { i8 }
%"class.hls::stream.0.30" = type { %struct.ap_out.29 }
%struct.ap_out.29 = type { %struct.ap_out_item.25, %struct.ap_uint.28 }
%struct.ap_out_item.25 = type { i32, i32 }
...
define internal fastcc void @rollingHash(i8* %str, i32* %hash) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i8* %str}, i64 0, metadata !3137), !dbg !3138 ; [debug line = 36:23] [debug variable = str]
  call void @llvm.dbg.value(metadata !{i32* %hash}, i64 0, metadata !3139), !dbg !3140 ; [debug line = 36:38] [debug variable = hash]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %str, i32 8192) nounwind, !dbg !3141 ; [debug line = 36:59]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %hash, i32 7169) nounwind, !dbg !3143 ; [debug line = 36:92]
  br label %1, !dbg !3144                         ; [debug line = 41:6]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.2, %2 ]            ; [#uses=3 type=i32]
  %sum = phi i32 [ 0, %0 ], [ %sum.2, %2 ]        ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %i, 1024, !dbg !3144   ; [#uses=1 type=i1] [debug line = 41:6]
  br i1 %exitcond1, label %3, label %2, !dbg !3144 ; [debug line = 41:6]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([19 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3146 ; [debug line = 41:24]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([19 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !3146 ; [#uses=1 type=i32] [debug line = 41:24]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3148 ; [debug line = 42:1]
  %tmp = sext i32 %i to i64, !dbg !3149           ; [#uses=1 type=i64] [debug line = 43:2]
  %str.addr = getelementptr inbounds i8* %str, i64 %tmp, !dbg !3149 ; [#uses=1 type=i8*] [debug line = 43:2]
  %str.load = load i8* %str.addr, align 1, !dbg !3149 ; [#uses=2 type=i8] [debug line = 43:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %str.load) nounwind
  %tmp.1 = sext i8 %str.load to i32, !dbg !3149   ; [#uses=1 type=i32] [debug line = 43:2]
  %sum.2 = add nsw i32 %tmp.1, %sum, !dbg !3149   ; [#uses=1 type=i32] [debug line = 43:2]
  call void @llvm.dbg.value(metadata !{i32 %sum.2}, i64 0, metadata !3150), !dbg !3149 ; [debug line = 43:2] [debug variable = sum]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([19 x i8]* @.str3, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3151 ; [#uses=0 type=i32] [debug line = 44:2]
  %i.2 = add nsw i32 %i, 1, !dbg !3152            ; [#uses=1 type=i32] [debug line = 41:19]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !3153), !dbg !3152 ; [debug line = 41:19] [debug variable = i]
  br label %1, !dbg !3152                         ; [debug line = 41:19]

; <label>:3                                       ; preds = %1
  %sum.0.lcssa = phi i32 [ %sum, %1 ]             ; [#uses=2 type=i32]
  store i32 %sum.0.lcssa, i32* %hash, align 4, !dbg !3154 ; [debug line = 45:2]
  br label %4, !dbg !3155                         ; [debug line = 48:6]

; <label>:4                                       ; preds = %5, %3
  %i.1 = phi i32 [ 1, %3 ], [ %i.3, %5 ]          ; [#uses=5 type=i32]
  %sum.1 = phi i32 [ %sum.0.lcssa, %3 ], [ %sum.3, %5 ] ; [#uses=1 type=i32]
  %exitcond = icmp eq i32 %i.1, 7168, !dbg !3155  ; [#uses=1 type=i1] [debug line = 48:6]
  br i1 %exitcond, label %6, label %5, !dbg !3155 ; [debug line = 48:6]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !3157 ; [debug line = 48:30]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !3157 ; [#uses=1 type=i32] [debug line = 48:30]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3159 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3160 ; [debug line = 50:1]
  %tmp.4 = add nsw i32 %i.1, 1023, !dbg !3161     ; [#uses=1 type=i32] [debug line = 51:2]
  %tmp.5 = sext i32 %tmp.4 to i64, !dbg !3161     ; [#uses=1 type=i64] [debug line = 51:2]
  %str.addr.1 = getelementptr inbounds i8* %str, i64 %tmp.5, !dbg !3161 ; [#uses=1 type=i8*] [debug line = 51:2]
  %str.load.1 = load i8* %str.addr.1, align 1, !dbg !3161 ; [#uses=2 type=i8] [debug line = 51:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %str.load.1) nounwind
  %tmp.6 = sext i8 %str.load.1 to i32, !dbg !3161 ; [#uses=1 type=i32] [debug line = 51:2]
  %tmp.7 = add nsw i32 %i.1, -1, !dbg !3161       ; [#uses=1 type=i32] [debug line = 51:2]
  %tmp.8 = sext i32 %tmp.7 to i64, !dbg !3161     ; [#uses=1 type=i64] [debug line = 51:2]
  %str.addr.2 = getelementptr inbounds i8* %str, i64 %tmp.8, !dbg !3161 ; [#uses=1 type=i8*] [debug line = 51:2]
  %str.load.2 = load i8* %str.addr.2, align 1, !dbg !3161 ; [#uses=2 type=i8] [debug line = 51:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %str.load.2) nounwind
  %tmp.9 = sext i8 %str.load.2 to i32, !dbg !3161 ; [#uses=1 type=i32] [debug line = 51:2]
  %.neg = sub i32 0, %tmp.9                       ; [#uses=1 type=i32]
  %tmp.10 = add i32 %tmp.6, %sum.1, !dbg !3161    ; [#uses=1 type=i32] [debug line = 51:2]
  %sum.3 = add i32 %tmp.10, %.neg, !dbg !3161     ; [#uses=2 type=i32] [debug line = 51:2]
  call void @llvm.dbg.value(metadata !{i32 %sum.3}, i64 0, metadata !3150), !dbg !3161 ; [debug line = 51:2] [debug variable = sum]
  %tmp.12 = sext i32 %i.1 to i64, !dbg !3162      ; [#uses=1 type=i64] [debug line = 52:3]
  %hash.addr = getelementptr inbounds i32* %hash, i64 %tmp.12, !dbg !3162 ; [#uses=1 type=i32*] [debug line = 52:3]
  store i32 %sum.3, i32* %hash.addr, align 4, !dbg !3162 ; [debug line = 52:3]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !3163 ; [#uses=0 type=i32] [debug line = 53:2]
  %i.3 = add nsw i32 %i.1, 1, !dbg !3164          ; [#uses=1 type=i32] [debug line = 48:25]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !3153), !dbg !3164 ; [debug line = 48:25] [debug variable = i]
  br label %4, !dbg !3164                         ; [debug line = 48:25]

; <label>:6                                       ; preds = %4
  ret void, !dbg !3165                            ; [debug line = 54:1]
}
...
define internal fastcc i32 @murmurhash(i8* %key, i32 %len) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i8* %key}, i64 0, metadata !3166), !dbg !3167 ; [debug line = 101:29] [debug variable = key]
  call void @llvm.dbg.value(metadata !{i32 %len}, i64 0, metadata !3168), !dbg !3169 ; [debug line = 101:43] [debug variable = len]
  call void (...)* @_ssdm_InlineSelf(i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3170 ; [debug line = 102:1]
  call void @llvm.dbg.declare(metadata !{[2048 x i32]* %kValues}, metadata !3172), !dbg !3176 ; [debug line = 105:12] [debug variable = kValues]
  br label %1, !dbg !3177                         ; [debug line = 110:16]

; <label>:1                                       ; preds = %2, %0
  %indvars.iv = phi i32 [ %kItr, %2 ], [ 0, %0 ]  ; [#uses=3 type=i32]
  %i = phi i32 [ %i.4, %2 ], [ 0, %0 ]            ; [#uses=6 type=i32]
  %tmp = icmp ult i32 %i, %len, !dbg !3177        ; [#uses=1 type=i1] [debug line = 110:16]
  br i1 %tmp, label %2, label %.preheader.preheader, !dbg !3177 ; [debug line = 110:16]

.preheader.preheader:                             ; preds = %1
  %indvars.iv.lcssa = phi i32 [ %indvars.iv, %1 ] ; [#uses=1 type=i32]
  br label %.preheader, !dbg !3179                ; [debug line = 125:17]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3181 ; [debug line = 110:33]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3181 ; [#uses=1 type=i32] [debug line = 110:33]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 2048, i32 1024, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3183 ; [debug line = 111:1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3184 ; [debug line = 114:1]
  %tmp.14 = or i32 %i, 3, !dbg !3185              ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.15 = sext i32 %tmp.14 to i64, !dbg !3185   ; [#uses=1 type=i64] [debug line = 116:81]
  %key.addr = getelementptr inbounds i8* %key, i64 %tmp.15, !dbg !3185 ; [#uses=1 type=i8*] [debug line = 116:81]
  %key.load = load i8* %key.addr, align 1, !dbg !3185 ; [#uses=2 type=i8] [debug line = 116:81]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load) nounwind
  %tmp.16 = zext i8 %key.load to i32, !dbg !3185  ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.17 = mul i32 %tmp.16, 16777216, !dbg !3185 ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.18 = or i32 %i, 2, !dbg !3185              ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.19 = sext i32 %tmp.18 to i64, !dbg !3185   ; [#uses=1 type=i64] [debug line = 116:81]
  %key.addr.1 = getelementptr inbounds i8* %key, i64 %tmp.19, !dbg !3185 ; [#uses=1 type=i8*] [debug line = 116:81]
  %key.load.1 = load i8* %key.addr.1, align 1, !dbg !3185 ; [#uses=2 type=i8] [debug line = 116:81]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load.1) nounwind
  %tmp.20 = sext i8 %key.load.1 to i32, !dbg !3185 ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.21 = mul i32 %tmp.20, 65536, !dbg !3185    ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.22 = or i32 %i, 1, !dbg !3185              ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.23 = sext i32 %tmp.22 to i64, !dbg !3185   ; [#uses=1 type=i64] [debug line = 116:81]
  %key.addr.2 = getelementptr inbounds i8* %key, i64 %tmp.23, !dbg !3185 ; [#uses=1 type=i8*] [debug line = 116:81]
  %key.load.2 = load i8* %key.addr.2, align 1, !dbg !3185 ; [#uses=2 type=i8] [debug line = 116:81]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load.2) nounwind
  %tmp.24 = sext i8 %key.load.2 to i32, !dbg !3185 ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.25 = mul i32 %tmp.24, 256, !dbg !3185      ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.26 = sext i32 %i to i64, !dbg !3185        ; [#uses=1 type=i64] [debug line = 116:81]
  %key.addr.3 = getelementptr inbounds i8* %key, i64 %tmp.26, !dbg !3185 ; [#uses=1 type=i8*] [debug line = 116:81]
  %key.load.3 = load i8* %key.addr.3, align 1, !dbg !3185 ; [#uses=2 type=i8] [debug line = 116:81]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load.3) nounwind
  %tmp.27 = sext i8 %key.load.3 to i32, !dbg !3185 ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.28 = add i32 %tmp.21, %tmp.17, !dbg !3185  ; [#uses=1 type=i32] [debug line = 116:81]
  %tmp.29 = add i32 %tmp.28, %tmp.25, !dbg !3185  ; [#uses=1 type=i32] [debug line = 116:81]
  %k = add i32 %tmp.29, %tmp.27, !dbg !3185       ; [#uses=2 type=i32] [debug line = 116:81]
  call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !3186), !dbg !3185 ; [debug line = 116:81] [debug variable = k]
  %k.1 = mul i32 %k, -862048943, !dbg !3187       ; [#uses=1 type=i32] [debug line = 117:4]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !3186), !dbg !3187 ; [debug line = 117:4] [debug variable = k]
  %tmp.30 = mul i32 %k, 380141568, !dbg !3188     ; [#uses=1 type=i32] [debug line = 118:4]
  %tmp.31 = lshr i32 %k.1, 17, !dbg !3188         ; [#uses=1 type=i32] [debug line = 118:4]
  %k.2 = or i32 %tmp.31, %tmp.30, !dbg !3188      ; [#uses=1 type=i32] [debug line = 118:4]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !3186), !dbg !3188 ; [debug line = 118:4] [debug variable = k]
  %k.4 = mul i32 %k.2, 461845907, !dbg !3189      ; [#uses=1 type=i32] [debug line = 119:4]
  call void @llvm.dbg.value(metadata !{i32 %k.4}, i64 0, metadata !3186), !dbg !3189 ; [debug line = 119:4] [debug variable = k]
  %kItr = add i32 %indvars.iv, 1, !dbg !3190      ; [#uses=1 type=i32] [debug line = 110:27]
  call void @llvm.dbg.value(metadata !{i32 %kItr}, i64 0, metadata !3191), !dbg !3192 ; [debug line = 121:4] [debug variable = kItr]
  %tmp.32 = sext i32 %indvars.iv to i64, !dbg !3192 ; [#uses=1 type=i64] [debug line = 121:4]
  %kValues.addr = getelementptr inbounds [2048 x i32]* %kValues, i64 0, i64 %tmp.32, !dbg !3192 ; [#uses=1 type=i32*] [debug line = 121:4]
  store i32 %k.4, i32* %kValues.addr, align 4, !dbg !3192 ; [debug line = 121:4]
  %rend5 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str7, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !3193 ; [#uses=0 type=i32] [debug line = 122:3]
  %i.4 = add nsw i32 %i, 4, !dbg !3190            ; [#uses=1 type=i32] [debug line = 110:27]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !3194), !dbg !3190 ; [debug line = 110:27] [debug variable = i]
  br label %1, !dbg !3190                         ; [debug line = 110:27]
...
.preheader:                                       ; preds = %3, %.preheader.preheader
  ...
  %exitcond = icmp eq i32 %i1, %indvars.iv.lcssa, !dbg !3179 ; [#uses=1 type=i1] [debug line = 125:17]
  br i1 %exitcond, label %4, label %3, !dbg !3179 ; [debug line = 125:17]

; <label>:3                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3195 ; [debug line = 125:34]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3195 ; [#uses=1 type=i32] [debug line = 125:34]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3197 ; [debug line = 126:1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 512, i32 256, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3198 ; [debug line = 128:1]
  %tmp.37 = sext i32 %i1 to i64, !dbg !3199       ; [#uses=1 type=i64] [debug line = 129:2]
  %kValues.addr.1 = getelementptr inbounds [2048 x i32]* %kValues, i64 0, i64 %tmp.37, !dbg !3199 ; [#uses=1 type=i32*] [debug line = 129:2]
  %kValues.load = load i32* %kValues.addr.1, align 4, !dbg !3199 ; [#uses=2 type=i32] [debug line = 129:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %kValues.load) nounwind
  %hash.2 = xor i32 %kValues.load, %hash, !dbg !3199 ; [#uses=2 type=i32] [debug line = 129:2]
  call void @llvm.dbg.value(metadata !{i32 %hash.2}, i64 0, metadata !3200), !dbg !3199 ; [debug line = 129:2] [debug variable = hash]
  %tmp.39 = shl i32 %hash.2, 13, !dbg !3201       ; [#uses=1 type=i32] [debug line = 130:4]
  %tmp.40 = lshr i32 %hash.2, 19, !dbg !3201      ; [#uses=1 type=i32] [debug line = 130:4]
  %hash.3 = or i32 %tmp.39, %tmp.40, !dbg !3201   ; [#uses=1 type=i32] [debug line = 130:4]
  call void @llvm.dbg.value(metadata !{i32 %hash.3}, i64 0, metadata !3200), !dbg !3201 ; [debug line = 130:4] [debug variable = hash]
  %tmp.42 = mul i32 %hash.3, 5, !dbg !3202        ; [#uses=1 type=i32] [debug line = 131:4]
  %hash.4 = add i32 %tmp.42, -430675100, !dbg !3202 ; [#uses=1 type=i32] [debug line = 131:4]
  call void @llvm.dbg.value(metadata !{i32 %hash.4}, i64 0, metadata !3200), !dbg !3202 ; [debug line = 131:4] [debug variable = hash]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str8, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3203 ; [#uses=0 type=i32] [debug line = 132:3]
  %i.5 = add nsw i32 %i1, 1, !dbg !3204           ; [#uses=1 type=i32] [debug line = 125:29]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !3205), !dbg !3204 ; [debug line = 125:29] [debug variable = i]
  br label %.preheader, !dbg !3204                ; [debug line = 125:29]

; <label>:4                                       ; preds = %.preheader
  %hash.0.lcssa = phi i32 [ %hash, %.preheader ]  ; [#uses=2 type=i32]
  %tmp.34 = zext i32 %len to i64, !dbg !3206      ; [#uses=1 type=i64] [debug line = 137:66]
  %tmp.35 = and i32 %len, 3, !dbg !3206           ; [#uses=2 type=i32] [debug line = 137:66]
  %tmp.36 = zext i32 %tmp.35 to i64, !dbg !3206   ; [#uses=1 type=i64] [debug line = 137:66]
  %.sum = sub i64 %tmp.34, %tmp.36, !dbg !3206    ; [#uses=3 type=i64] [debug line = 137:66]
  %tail = getelementptr inbounds i8* %key, i64 %.sum, !dbg !3206 ; [#uses=1 type=i8*] [debug line = 137:66]
  call void @llvm.dbg.value(metadata !{i8* %tail}, i64 0, metadata !3207), !dbg !3206 ; [debug line = 137:66] [debug variable = tail]
  switch i32 %tmp.35, label %._crit_edge [
    i32 3, label %5
    i32 2, label %._crit_edge2
    i32 1, label %._crit_edge3
  ], !dbg !3211                                   ; [debug line = 140:3]

; <label>:5                                       ; preds = %4
  %tail.0.sum1 = add i64 %.sum, 2, !dbg !3212     ; [#uses=1 type=i64] [debug line = 141:13]
  %key.addr.5 = getelementptr inbounds i8* %key, i64 %tail.0.sum1, !dbg !3212 ; [#uses=1 type=i8*] [debug line = 141:13]
  %key.load.4 = load i8* %key.addr.5, align 1, !dbg !3212 ; [#uses=2 type=i8] [debug line = 141:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load.4) nounwind
  %tmp.45 = zext i8 %key.load.4 to i32, !dbg !3212 ; [#uses=1 type=i32] [debug line = 141:13]
  %k.5 = shl nuw nsw i32 %tmp.45, 16, !dbg !3212  ; [#uses=1 type=i32] [debug line = 141:13]
  call void @llvm.dbg.value(metadata !{i32 %k.5}, i64 0, metadata !3214), !dbg !3212 ; [debug line = 141:13] [debug variable = k]
  br label %._crit_edge2, !dbg !3212              ; [debug line = 141:13]

._crit_edge2:                                     ; preds = %5, %4
  %k2 = phi i32 [ %k.5, %5 ], [ 0, %4 ]           ; [#uses=1 type=i32]
  %tail.0.sum = add i64 %.sum, 1, !dbg !3215      ; [#uses=1 type=i64] [debug line = 143:13]
  %key.addr.6 = getelementptr inbounds i8* %key, i64 %tail.0.sum, !dbg !3215 ; [#uses=1 type=i8*] [debug line = 143:13]
  %key.load.5 = load i8* %key.addr.6, align 1, !dbg !3215 ; [#uses=2 type=i8] [debug line = 143:13]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %key.load.5) nounwind
  %tmp.47 = zext i8 %key.load.5 to i32, !dbg !3215 ; [#uses=1 type=i32] [debug line = 143:13]
  %tmp.48 = shl nuw nsw i32 %tmp.47, 8, !dbg !3215 ; [#uses=1 type=i32] [debug line = 143:13]
  %k.6 = or i32 %tmp.48, %k2, !dbg !3215          ; [#uses=1 type=i32] [debug line = 143:13]
  call void @llvm.dbg.value(metadata !{i32 %k.6}, i64 0, metadata !3214), !dbg !3215 ; [debug line = 143:13] [debug variable = k]
  br label %._crit_edge3, !dbg !3215              ; [debug line = 143:13]

._crit_edge3:                                     ; preds = %._crit_edge2, %4
  %k2.1 = phi i32 [ %k.6, %._crit_edge2 ], [ 0, %4 ] ; [#uses=1 type=i32]
  %tail.load = load i8* %tail, align 1, !dbg !3216 ; [#uses=2 type=i8] [debug line = 146:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %tail.load) nounwind
  %tmp.50 = zext i8 %tail.load to i32, !dbg !3216 ; [#uses=1 type=i32] [debug line = 146:7]
  %k.7 = xor i32 %tmp.50, %k2.1, !dbg !3216       ; [#uses=2 type=i32] [debug line = 146:7]
  call void @llvm.dbg.value(metadata !{i32 %k.7}, i64 0, metadata !3214), !dbg !3216 ; [debug line = 146:7] [debug variable = k]
  %k.8 = mul i32 %k.7, -862048943, !dbg !3217     ; [#uses=1 type=i32] [debug line = 147:7]
  call void @llvm.dbg.value(metadata !{i32 %k.8}, i64 0, metadata !3214), !dbg !3217 ; [debug line = 147:7] [debug variable = k]
  %tmp.53 = mul i32 %k.7, 380141568, !dbg !3218   ; [#uses=1 type=i32] [debug line = 148:7]
  %tmp.54 = ashr i32 %k.8, 17, !dbg !3218         ; [#uses=1 type=i32] [debug line = 148:7]
  %k.9 = or i32 %tmp.54, %tmp.53, !dbg !3218      ; [#uses=1 type=i32] [debug line = 148:7]
  call void @llvm.dbg.value(metadata !{i32 %k.9}, i64 0, metadata !3214), !dbg !3218 ; [debug line = 148:7] [debug variable = k]
  %k.10 = mul nsw i32 %k.9, 461845907, !dbg !3219 ; [#uses=1 type=i32] [debug line = 149:7]
  call void @llvm.dbg.value(metadata !{i32 %k.10}, i64 0, metadata !3214), !dbg !3219 ; [debug line = 149:7] [debug variable = k]
  %hash.5 = xor i32 %k.10, %hash.0.lcssa, !dbg !3220 ; [#uses=1 type=i32] [debug line = 150:7]
  call void @llvm.dbg.value(metadata !{i32 %hash.5}, i64 0, metadata !3200), !dbg !3220 ; [debug line = 150:7] [debug variable = hash]
  br label %._crit_edge, !dbg !3221               ; [debug line = 151:3]

._crit_edge:                                      ; preds = %._crit_edge3, %4
  %hash.1 = phi i32 [ %hash.5, %._crit_edge3 ], [ %hash.0.lcssa, %4 ] ; [#uses=1 type=i32]
  %hash.6 = xor i32 %hash.1, %len, !dbg !3222     ; [#uses=2 type=i32] [debug line = 153:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.6}, i64 0, metadata !3200), !dbg !3222 ; [debug line = 153:3] [debug variable = hash]
  %tmp.59 = lshr i32 %hash.6, 16, !dbg !3223      ; [#uses=1 type=i32] [debug line = 154:3]
  %hash.7 = xor i32 %tmp.59, %hash.6, !dbg !3223  ; [#uses=1 type=i32] [debug line = 154:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.7}, i64 0, metadata !3200), !dbg !3223 ; [debug line = 154:3] [debug variable = hash]
  %hash.8 = mul i32 %hash.7, -2048144789, !dbg !3224 ; [#uses=2 type=i32] [debug line = 155:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.8}, i64 0, metadata !3200), !dbg !3224 ; [debug line = 155:3] [debug variable = hash]
  %tmp.62 = lshr i32 %hash.8, 13, !dbg !3225      ; [#uses=1 type=i32] [debug line = 156:3]
  %hash.9 = xor i32 %tmp.62, %hash.8, !dbg !3225  ; [#uses=1 type=i32] [debug line = 156:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.9}, i64 0, metadata !3200), !dbg !3225 ; [debug line = 156:3] [debug variable = hash]
  %hash.10 = mul i32 %hash.9, -1028477387, !dbg !3226 ; [#uses=2 type=i32] [debug line = 157:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.10}, i64 0, metadata !3200), !dbg !3226 ; [debug line = 157:3] [debug variable = hash]
  %tmp.65 = lshr i32 %hash.10, 16, !dbg !3227     ; [#uses=1 type=i32] [debug line = 158:3]
  %hash.11 = xor i32 %tmp.65, %hash.10, !dbg !3227 ; [#uses=1 type=i32] [debug line = 158:3]
  call void @llvm.dbg.value(metadata !{i32 %hash.11}, i64 0, metadata !3200), !dbg !3227 ; [debug line = 158:3] [debug variable = hash]
  ret i32 %hash.11, !dbg !3228                    ; [debug line = 160:3]
}
...
define internal fastcc void @extractIndices(i32* %hash, i32* %indices) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32* %hash}, i64 0, metadata !3229), !dbg !3230 ; [debug line = 23:25] [debug variable = hash]
  call void @llvm.dbg.value(metadata !{i32* %indices}, i64 0, metadata !3231), !dbg !3232 ; [debug line = 23:47] [debug variable = indices]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %indices, i32 7) nounwind, !dbg !3233 ; [debug line = 23:59]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %hash, i32 7168) nounwind, !dbg !3235 ; [debug line = 23:93]
  br label %1, !dbg !3236                         ; [debug line = 26:6]

; <label>:1                                       ; preds = %6, %0
  %i = phi i32 [ 0, %0 ], [ %i.6, %6 ]            ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 1024, !dbg !3236   ; [#uses=1 type=i1] [debug line = 26:6]
  br i1 %exitcond1, label %7, label %2, !dbg !3236 ; [debug line = 26:6]

; <label>:2                                       ; preds = %1
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !3238 ; [#uses=1 type=i32] [debug line = 26:24]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3240 ; [debug line = 27:1]
  br label %3, !dbg !3241                         ; [debug line = 28:6]

; <label>:3                                       ; preds = %._crit_edge, %2
  %j = phi i32 [ 0, %2 ], [ %j.1, %._crit_edge ]  ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %j, 7, !dbg !3241       ; [#uses=1 type=i1] [debug line = 28:6]
  br i1 %exitcond, label %6, label %4, !dbg !3241 ; [debug line = 28:6]

; <label>:4                                       ; preds = %3
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3243 ; [#uses=1 type=i32] [debug line = 28:21]
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3245 ; [debug line = 29:1]
  %tmp = shl nsw i32 %j, 10, !dbg !3246           ; [#uses=1 type=i32] [debug line = 30:27]
  %offset = add nsw i32 %tmp, %i, !dbg !3246      ; [#uses=2 type=i32] [debug line = 30:27]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !3247), !dbg !3246 ; [debug line = 30:27] [debug variable = offset]
  %tmp.67 = sext i32 %offset to i64, !dbg !3248   ; [#uses=1 type=i64] [debug line = 31:4]
  %hash.addr = getelementptr inbounds i32* %hash, i64 %tmp.67, !dbg !3248 ; [#uses=1 type=i32*] [debug line = 31:4]
  %hash.load = load i32* %hash.addr, align 4, !dbg !3248 ; [#uses=2 type=i32] [debug line = 31:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %hash.load) nounwind
  %tmp.68 = and i32 %hash.load, 859, !dbg !3248   ; [#uses=1 type=i32] [debug line = 31:4]
  %tmp.69 = icmp eq i32 %tmp.68, 330, !dbg !3248  ; [#uses=1 type=i1] [debug line = 31:4]
  br i1 %tmp.69, label %5, label %._crit_edge, !dbg !3248 ; [debug line = 31:4]

; <label>:5                                       ; preds = %4
  %tmp.70 = add nsw i32 %offset, 1024, !dbg !3249 ; [#uses=1 type=i32] [debug line = 31:36]
  %tmp.71 = sext i32 %j to i64, !dbg !3249        ; [#uses=1 type=i64] [debug line = 31:36]
  %indices.addr = getelementptr inbounds i32* %indices, i64 %tmp.71, !dbg !3249 ; [#uses=1 type=i32*] [debug line = 31:36]
  store i32 %tmp.70, i32* %indices.addr, align 4, !dbg !3249 ; [debug line = 31:36]
  br label %._crit_edge, !dbg !3249               ; [debug line = 31:36]

._crit_edge:                                      ; preds = %5, %4
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3250 ; [#uses=0 type=i32] [debug line = 32:3]
  %j.1 = add nsw i32 %j, 1, !dbg !3251            ; [#uses=1 type=i32] [debug line = 28:16]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !3252), !dbg !3251 ; [debug line = 28:16] [debug variable = j]
  br label %3, !dbg !3251                         ; [debug line = 28:16]

; <label>:6                                       ; preds = %3
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !3253 ; [#uses=0 type=i32] [debug line = 33:2]
  %i.6 = add nsw i32 %i, 1, !dbg !3254            ; [#uses=1 type=i32] [debug line = 26:19]
  call void @llvm.dbg.value(metadata !{i32 %i.6}, i64 0, metadata !3255), !dbg !3254 ; [debug line = 26:19] [debug variable = i]
  br label %1, !dbg !3254                         ; [debug line = 26:19]

; <label>:7                                       ; preds = %1
  ret void, !dbg !3256                            ; [debug line = 34:1]
}
...
define void @dedupDriver(%"class.hls::stream.24"* %inputData, %"class.hls::stream.0.30"* %outputData) nounwind uwtable {
  ...
  %tmp.83 = alloca %struct.ap_out.29, align 4     ; [#uses=4 type=%struct.ap_out.29*]
  ...
  %item = alloca %struct.ap_out.29, align 4       ; [#uses=3 type=%struct.ap_out.29*]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %inputData}, i64 0, metadata !3257), !dbg !3258 ; [debug line = 163:37] [debug variable = inputData]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.30"* %outputData}, i64 0, metadata !3259), !dbg !3260 ; [debug line = 163:69] [debug variable = outputData]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.0.30"* %outputData, i8* getelementptr inbounds ([5 x i8]* @.str9, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3261 ; [debug line = 164:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.24"* %inputData, i8* getelementptr inbounds ([5 x i8]* @.str9, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3263 ; [debug line = 165:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str10, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3264 ; [debug line = 166:1]
  call void @llvm.dbg.declare(metadata !{[8192 x i8]* %buffer}, metadata !3265), !dbg !3269 ; [debug line = 168:7] [debug variable = buffer]
  %buffer.addr = getelementptr inbounds [8192 x i8]* %buffer, i64 0, i64 0, !dbg !3270 ; [#uses=3 type=i8*] [debug line = 169:1]
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i8* %buffer.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0), i32 128, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3271 ; [debug line = 170:1]
  call void @llvm.dbg.declare(metadata !{[7 x i32]* %indices}, metadata !3272), !dbg !3276 ; [debug line = 171:6] [debug variable = indices]
  br label %meminst

meminst:                                          ; preds = %meminst, %0
  %invdar = phi i32 [ 0, %0 ], [ %indvarinc, %meminst ], !dbg !3277 ; [#uses=3 type=i32] [debug line = 172:2]
  %indvarinc = add i32 %invdar, 1, !dbg !3277     ; [#uses=1 type=i32] [debug line = 172:2]
  %tmp = sext i32 %invdar to i64, !dbg !3277      ; [#uses=1 type=i64] [debug line = 172:2]
  %indices.addr = getelementptr [7 x i32]* %indices, i64 0, i64 %tmp, !dbg !3277 ; [#uses=1 type=i32*] [debug line = 172:2]
  store i32 0, i32* %indices.addr, align 4, !dbg !3277 ; [debug line = 172:2]
  %tmp.73 = icmp eq i32 %invdar, 6, !dbg !3277    ; [#uses=1 type=i1] [debug line = 172:2]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @memset_indices.str)
  br i1 %tmp.73, label %1, label %meminst, !dbg !3277 ; [debug line = 172:2]

; <label>:1                                       ; preds = %meminst
  %inputData.addr = getelementptr inbounds %"class.hls::stream.24"* %inputData, i64 0, i32 0, !dbg !3278 ; [#uses=1 type=i8*] [debug line = 131:9@178:14]
  br label %2, !dbg !3283                         ; [debug line = 176:13]

; <label>:2                                       ; preds = %3, %1
  %i = phi i32 [ 0, %1 ], [ %i.7, %3 ]            ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 8192, !dbg !3283   ; [#uses=1 type=i1] [debug line = 176:13]
  br i1 %exitcond1, label %4, label %3, !dbg !3283 ; [debug line = 176:13]

; <label>:3                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([11 x i8]* @.str12, i64 0, i64 0)) nounwind, !dbg !3284 ; [debug line = 176:28]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([11 x i8]* @.str12, i64 0, i64 0)) nounwind, !dbg !3284 ; [#uses=1 type=i32] [debug line = 176:28]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3285 ; [debug line = 177:1]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.24"* %inputData}, i64 0, metadata !3286), !dbg !3288 ; [debug line = 129:56@178:14] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{i8* %tmp.74}, metadata !3289) nounwind, !dbg !3290 ; [debug line = 130:22@178:14] [debug variable = tmp]
  call void @_ssdm_op_IfRead.Stream.i8P.i8P(i8* %inputData.addr, i8* %tmp.74) nounwind, !dbg !3278 ; [debug line = 131:9@178:14]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  ...
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{i8* %tmp.74}, i64 0, metadata !3289), !dbg !3291 ; [debug line = 132:9@178:14] [debug variable = tmp]
  %tmp.74.load = load i8* %tmp.74, align 1, !dbg !3291 ; [#uses=1 type=i8] [debug line = 132:9@178:14]
  %tmp.75 = sext i32 %i to i64, !dbg !3280        ; [#uses=1 type=i64] [debug line = 178:14]
  %buffer.addr.1 = getelementptr inbounds [8192 x i8]* %buffer, i64 0, i64 %tmp.75, !dbg !3280 ; [#uses=1 type=i8*] [debug line = 178:14]
  store i8 %tmp.74.load, i8* %buffer.addr.1, align 1, !dbg !3280 ; [debug line = 178:14]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([11 x i8]* @.str12, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3292 ; [#uses=0 type=i32] [debug line = 179:2]
  %i.7 = add nsw i32 %i, 1, !dbg !3293            ; [#uses=1 type=i32] [debug line = 176:23]
  call void @llvm.dbg.value(metadata !{i32 %i.7}, i64 0, metadata !3294), !dbg !3293 ; [debug line = 176:23] [debug variable = i]
  br label %2, !dbg !3293                         ; [debug line = 176:23]

; <label>:4                                       ; preds = %2
  %indices.addr.1 = getelementptr inbounds [7 x i32]* %indices, i64 0, i64 0, !dbg !3295 ; [#uses=1 type=i32*] [debug line = 184:2]
  call fastcc void @calcHash(i8* %buffer.addr, i32* %indices.addr.1), !dbg !3295 ; [debug line = 184:2]
  %.04.addr = getelementptr inbounds %struct.ap_out.29* %item, i64 0, i32 0, i32 1, !dbg !3296 ; [#uses=3 type=i32*] [debug line = 203:4]
  %.04.addr.1 = getelementptr inbounds %struct.ap_out.29* %item, i64 0, i32 0, i32 0, !dbg !3300 ; [#uses=1 type=i32*] [debug line = 205:3]
  %.04.addr.2 = getelementptr inbounds %struct.ap_out.29* %item, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3301 ; [#uses=1 type=i1*] [debug line = 277:10@206:3]
  %tmp.i1.addr = getelementptr inbounds %struct.ap_out.29* %tmp.83, i64 0, i32 0, i32 0, !dbg !3304 ; [#uses=1 type=i32*] [debug line = 145:31@207:3]
  %tmp.i1.addr.1 = getelementptr inbounds %struct.ap_out.29* %tmp.83, i64 0, i32 0, i32 1, !dbg !3304 ; [#uses=1 type=i32*] [debug line = 145:31@207:3]
  %tmp.i1.addr.2 = getelementptr inbounds %struct.ap_out.29* %tmp.83, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3304 ; [#uses=1 type=i1*] [debug line = 145:31@207:3]
  %outputData.addr = getelementptr inbounds %"class.hls::stream.0.30"* %outputData, i64 0, i32 0, !dbg !3307 ; [#uses=1 type=%struct.ap_out.29*] [debug line = 146:9@207:3]
  br label %5, !dbg !3308                         ; [debug line = 191:15]

; <label>:5                                       ; preds = %9, %4
  %lastIndex = phi i32 [ 0, %4 ], [ %lastIndex.1, %9 ] ; [#uses=3 type=i32]
  %i1 = phi i32 [ 0, %4 ], [ %i.8, %9 ]           ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %i1, 7, !dbg !3308      ; [#uses=1 type=i1] [debug line = 191:15]
  br i1 %exitcond, label %10, label %6, !dbg !3308 ; [debug line = 191:15]

; <label>:6                                       ; preds = %5
  call void @llvm.dbg.declare(metadata !{%struct.ap_out.29* %item}, metadata !3309), !dbg !3310 ; [debug line = 196:17] [debug variable = item]
  call void @llvm.dbg.value(metadata !{%struct.ap_out.29* %item}, i64 0, metadata !3311), !dbg !3314 ; [debug line = 13:8@196:21] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_out.29* %item}, i64 0, metadata !3315), !dbg !3316 ; [debug line = 13:8@13:8@196:21] [debug variable = this]
  %tmp.77 = sext i32 %i1 to i64, !dbg !3317       ; [#uses=1 type=i64] [debug line = 198:3]
  %indices.addr.2 = getelementptr inbounds [7 x i32]* %indices, i64 0, i64 %tmp.77, !dbg !3317 ; [#uses=3 type=i32*] [debug line = 198:3]
  %indices.load = load i32* %indices.addr.2, align 4, !dbg !3317 ; [#uses=4 type=i32] [debug line = 198:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indices.load) nounwind
  %tmp.78 = icmp eq i32 %indices.load, 0, !dbg !3317 ; [#uses=1 type=i1] [debug line = 198:3]
  br i1 %tmp.78, label %8, label %7, !dbg !3317   ; [debug line = 198:3]

; <label>:7                                       ; preds = %6
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indices.load) nounwind
  %dataLen = sub i32 %indices.load, %lastIndex, !dbg !3318 ; [#uses=1 type=i32] [debug line = 199:4]
  call void @llvm.dbg.value(metadata !{i32 %dataLen}, i64 0, metadata !3320), !dbg !3318 ; [debug line = 199:4] [debug variable = dataLen]
  %tmp.80 = zext i32 %lastIndex to i64, !dbg !3321 ; [#uses=1 type=i64] [debug line = 200:25]
  %buffer.addr.2 = getelementptr inbounds [8192 x i8]* %buffer, i64 0, i64 %tmp.80, !dbg !3321 ; [#uses=1 type=i8*] [debug line = 200:25]
  %tmp.81 = call fastcc i32 @murmurhash(i8* %buffer.addr.2, i32 %dataLen), !dbg !3321 ; [#uses=1 type=i32] [debug line = 200:25]
  store i32 %tmp.81, i32* %.04.addr, align 4, !dbg !3321 ; [debug line = 200:25]
  %lastIndex.2 = load i32* %indices.addr.2, align 4, !dbg !3322 ; [#uses=2 type=i32] [debug line = 201:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lastIndex.2) nounwind
  call void @llvm.dbg.value(metadata !{i32 %lastIndex.2}, i64 0, metadata !3323), !dbg !3322 ; [debug line = 201:4] [debug variable = lastIndex]
  br label %9, !dbg !3324                         ; [debug line = 202:3]

; <label>:8                                       ; preds = %6
  store i32 0, i32* %.04.addr, align 4, !dbg !3296 ; [debug line = 203:4]
  br label %9

; <label>:9                                       ; preds = %8, %7
  %lastIndex.1 = phi i32 [ %lastIndex.2, %7 ], [ %lastIndex, %8 ] ; [#uses=1 type=i32]
  %indices.load.2 = load i32* %indices.addr.2, align 4, !dbg !3300 ; [#uses=4 type=i32] [debug line = 205:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indices.load.2) nounwind
  store i32 %indices.load.2, i32* %.04.addr.1, align 4, !dbg !3300 ; [debug line = 205:3]
  %tmp.82 = icmp eq i32 %i1, 6, !dbg !3303        ; [#uses=3 type=i1] [debug line = 206:3]
  store i1 %tmp.82, i1* %.04.addr.2, align 4, !dbg !3301 ; [debug line = 277:10@206:3]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.0.30"* %outputData}, i64 0, metadata !3325), !dbg !3327 ; [debug line = 144:48@207:3] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_out.29* %item}, i64 0, metadata !3328), !dbg !3329 ; [debug line = 144:74@207:3] [debug variable = din]
  call void @llvm.dbg.declare(metadata !{%struct.ap_out.29* %tmp.83}, metadata !3330) nounwind, !dbg !3331 ; [debug line = 145:22@207:3] [debug variable = tmp]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %indices.load.2) nounwind
  store i32 %indices.load.2, i32* %tmp.i1.addr, align 4, !dbg !3304 ; [debug line = 145:31@207:3]
  %.04.load = load i32* %.04.addr, align 4, !dbg !3304 ; [#uses=2 type=i32] [debug line = 145:31@207:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %.04.load) nounwind
  store i32 %.04.load, i32* %tmp.i1.addr.1, align 4, !dbg !3304 ; [debug line = 145:31@207:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.82) nounwind
  store i1 %tmp.82, i1* %tmp.i1.addr.2, align 4, !dbg !3304 ; [debug line = 145:31@207:3]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_out.29 = type { %struct.ap_out_item.25, %struct.ap_uint.28 }P.%struct.ap_out.29 = type { %struct.ap_out_item.25, %struct.ap_uint.28 }P"(%struct.ap_out.29* %outputData.addr, %struct.ap_out.29* %tmp.83) nounwind, !dbg !3307 ; [debug line = 146:9@207:3]
  %i.8 = add nsw i32 %i1, 1, !dbg !3332           ; [#uses=1 type=i32] [debug line = 191:24]
  call void @llvm.dbg.value(metadata !{i32 %i.8}, i64 0, metadata !3333), !dbg !3332 ; [debug line = 191:24] [debug variable = i]
  br label %5, !dbg !3332                         ; [debug line = 191:24]

; <label>:10                                      ; preds = %5
  ret void, !dbg !3334                            ; [debug line = 210:1]
}
...
define internal fastcc void @calcHash(i8* %str, i32* %indices) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i8* %str}, i64 0, metadata !3335), !dbg !3336 ; [debug line = 79:20] [debug variable = str]
  call void @llvm.dbg.value(metadata !{i32* %indices}, i64 0, metadata !3337), !dbg !3338 ; [debug line = 79:35] [debug variable = indices]
  call void (...)* @_ssdm_SpecArrayDimSize(i8* %str, i32 8192) nounwind, !dbg !3339 ; [debug line = 79:47]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %indices, i32 7) nounwind, !dbg !3341 ; [debug line = 79:80]
  call void @llvm.dbg.declare(metadata !{[7168 x i32]* %hash}, metadata !3342), !dbg !3346 ; [debug line = 81:6] [debug variable = hash]
  %hash.addr = getelementptr inbounds [7168 x i32]* %hash, i64 0, i64 0, !dbg !3347 ; [#uses=4 type=i32*] [debug line = 82:1]
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i32* %hash.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str6, i64 0, i64 0), i32 128, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3348 ; [debug line = 83:1]
  call fastcc void @rollingHash(i8* %str, i32* %hash.addr), !dbg !3349 ; [debug line = 86:2]
  call fastcc void @extractIndices(i32* %hash.addr, i32* %indices), !dbg !3350 ; [debug line = 89:2]
  ret void, !dbg !3351                            ; [debug line = 91:1]
}
...
; [#uses=1]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_out.29 = type { %struct.ap_out_item.25, %struct.ap_uint.28 }P.%struct.ap_out.29 = type { %struct.ap_out_item.25, %struct.ap_uint.28 }P"(%struct.ap_out.29*, %struct.ap_out.29*)
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/insujang/cs710/HEAD/FPGA/DedupHWModule_HLS/Dedup/.autopilot/db/dedup.pragma.2.cpp", metadata !"/home/insujang/cs710/HEAD/FPGA", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !897, metadata !899, metadata !1388} ; [ DW_TAG_compile_unit ]
...
!901 = metadata !{i32 786478, i32 0, metadata !902, metadata !"extractIndices", metadata !"extractIndices", metadata !"_Z14extractIndicesPiS_", metadata !902, i32 23, metadata !903, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @extractIndices, null, null, metadata !89, i32 23} ; [ DW_TAG_subprogram ]
!902 = metadata !{i32 786473, metadata !"DedupHWModule_HLS/Dedup/dedup.cpp", metadata !"/home/insujang/cs710/HEAD/FPGA", null} ; [ DW_TAG_file_type ]
...
!906 = metadata !{i32 786478, i32 0, metadata !902, metadata !"rollingHash", metadata !"rollingHash", metadata !"_Z11rollingHashPcPi", metadata !902, i32 36, metadata !907, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*, i32*)* @rollingHash, null, null, metadata !89, i32 36} ; [ DW_TAG_subprogram ]
!907 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !908, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!908 = metadata !{null, metadata !213, metadata !905}
!909 = metadata !{i32 786478, i32 0, metadata !902, metadata !"calcHash", metadata !"calcHash", metadata !"_Z8calcHashPcPi", metadata !902, i32 79, metadata !907, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8*, i32*)* @calcHash, null, null, metadata !89, i32 79} ; [ DW_TAG_subprogram ]
!910 = metadata !{i32 786478, i32 0, metadata !902, metadata !"murmurhash", metadata !"murmurhash", metadata !"_Z10murmurhashPcjj", metadata !902, i32 101, metadata !911, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 101} ; [ DW_TAG_subprogram ]
...
!915 = metadata !{i32 786478, i32 0, metadata !902, metadata !"dedupDriver", metadata !"dedupDriver", metadata !"_Z11dedupDriverRN3hls6streamIcEERNS0_I6ap_outEE", metadata !902, i32 163, metadata !916, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%"class.hls::stream.24"*, %"class.hls::stream.0.30"*)* @dedupDriver, null, null, metadata !89, i32 163} ; [ DW_TAG_subprogram ]
...
!967 = metadata !{i32 786434, metadata !920, metadata !"stream<ap_out>", metadata !921, i32 79, i64 96, i64 32, i32 0, i32 0, null, metadata !968, i32 0, null, metadata !1375} ; [ DW_TAG_class_type ]
...
!970 = metadata !{i32 786434, null, metadata !"ap_out", metadata !902, i32 13, i64 96, i64 32, i32 0, i32 0, null, metadata !971, i32 0, null, null} ; [ DW_TAG_class_type ]
!971 = metadata !{metadata !972, metadata !981, metadata !1328}
!972 = metadata !{i32 786445, metadata !970, metadata !"data", metadata !902, i32 14, i64 64, i64 32, i64 0, i32 0, metadata !973} ; [ DW_TAG_member ]
!973 = metadata !{i32 786434, null, metadata !"ap_out_item", metadata !902, i32 8, i64 64, i64 32, i32 0, i32 0, null, metadata !974, i32 0, null, null} ; [ DW_TAG_class_type ]
!974 = metadata !{metadata !975, metadata !976, metadata !977}
!975 = metadata !{i32 786445, metadata !973, metadata !"index", metadata !902, i32 9, i64 32, i64 32, i64 0, i32 0, metadata !56} ; [ DW_TAG_member ]
!976 = metadata !{i32 786445, metadata !973, metadata !"hashData", metadata !902, i32 10, i64 32, i64 32, i64 32, i32 0, metadata !56} ; [ DW_TAG_member ]
!977 = metadata !{i32 786478, i32 0, metadata !973, metadata !"ap_out_item", metadata !"ap_out_item", metadata !"", metadata !902, i32 8, metadata !978, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !89, i32 8} ; [ DW_TAG_subprogram ]
...
!981 = metadata !{i32 786445, metadata !970, metadata !"last", metadata !902, i32 15, i64 8, i64 8, i64 64, i32 0, metadata !982} ; [ DW_TAG_member ]
...
!1328 = metadata !{i32 786478, i32 0, metadata !970, metadata !"ap_out", metadata !"ap_out", metadata !"", metadata !902, i32 13, metadata !1329, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !89, i32 13} ; [ DW_TAG_subprogram ]
...
!1344 = metadata !{i32 786478, i32 0, metadata !967, metadata !"operator=", metadata !"operator=", metadata !"_ZN3hls6streamI6ap_outEaSERKS2_", metadata !921, i32 94, metadata !1345, i1 false, i1 false, i32 0, i32 0, null, i32 257, i1 false, null, null, i32 0, metadata !89, i32 94} ; [ DW_TAG_subprogram ]
!1345 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !1346, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!1346 = metadata !{metadata !966, metadata !1335, metadata !1342}
!1347 = metadata !{i32 786478, i32 0, metadata !967, metadata !"operator>>", metadata !"operator>>", metadata !"_ZN3hls6streamI6ap_outErsERS1_", metadata !921, i32 101, metadata !1348, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 101} ; [ DW_TAG_subprogram ]
...
!1351 = metadata !{i32 786478, i32 0, metadata !967, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamI6ap_outElsERKS1_", metadata !921, i32 105, metadata !1352, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 105} ; [ DW_TAG_subprogram ]
...
!1356 = metadata !{i32 786478, i32 0, metadata !967, metadata !"empty", metadata !"empty", metadata !"_ZNK3hls6streamI6ap_outE5emptyEv", metadata !921, i32 112, metadata !1357, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 112} ; [ DW_TAG_subprogram ]
...
!1360 = metadata !{i32 786478, i32 0, metadata !967, metadata !"full", metadata !"full", metadata !"_ZNK3hls6streamI6ap_outE4fullEv", metadata !921, i32 117, metadata !1357, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 117} ; [ DW_TAG_subprogram ]
!1361 = metadata !{i32 786478, i32 0, metadata !967, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI6ap_outE4readERS1_", metadata !921, i32 123, metadata !1348, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 123} ; [ DW_TAG_subprogram ]
!1362 = metadata !{i32 786478, i32 0, metadata !967, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI6ap_outE4readEv", metadata !921, i32 129, metadata !1363, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 129} ; [ DW_TAG_subprogram ]
!1363 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !1364, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!1364 = metadata !{metadata !970, metadata !1335}
!1365 = metadata !{i32 786478, i32 0, metadata !967, metadata !"read_nb", metadata !"read_nb", metadata !"_ZN3hls6streamI6ap_outE7read_nbERS1_", metadata !921, i32 136, metadata !1366, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 136} ; [ DW_TAG_subprogram ]
!1366 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !1367, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!1367 = metadata !{metadata !238, metadata !1335, metadata !1350}
!1368 = metadata !{i32 786478, i32 0, metadata !967, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI6ap_outE5writeERKS1_", metadata !921, i32 144, metadata !1352, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 144} ; [ DW_TAG_subprogram ]
!1369 = metadata !{i32 786478, i32 0, metadata !967, metadata !"write_nb", metadata !"write_nb", metadata !"_ZN3hls6streamI6ap_outE8write_nbERKS1_", metadata !921, i32 150, metadata !1370, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 150} ; [ DW_TAG_subprogram ]
...
!1372 = metadata !{i32 786478, i32 0, metadata !967, metadata !"size", metadata !"size", metadata !"_ZN3hls6streamI6ap_outE4sizeEv", metadata !921, i32 157, metadata !1373, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !89, i32 157} ; [ DW_TAG_subprogram ]
...
!1377 = metadata !{i32 786478, i32 0, metadata !920, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI6ap_outE5writeERKS1_", metadata !921, i32 144, metadata !1352, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1368, metadata !89, i32 144} ; [ DW_TAG_subprogram ]
...
!1384 = metadata !{i32 786478, i32 0, null, metadata !"ap_out", metadata !"ap_out", metadata !"_ZN6ap_outC1Ev", metadata !902, i32 13, metadata !1329, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !1328, metadata !89, i32 13} ; [ DW_TAG_subprogram ]
!1385 = metadata !{i32 786478, i32 0, null, metadata !"ap_out", metadata !"ap_out", metadata !"_ZN6ap_outC2Ev", metadata !902, i32 13, metadata !1329, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !1328, metadata !89, i32 13} ; [ DW_TAG_subprogram ]
...
!1739 = metadata !{metadata !1740, metadata !2244, metadata !2245, metadata !2247, metadata !2253, metadata !2256, metadata !2264, metadata !2272, metadata !2275, metadata !2278, metadata !2282, metadata !2285, metadata !2288, metadata !2291, metadata !2294, metadata !2297, metadata !2300, metadata !2303, metadata !2306, metadata !2309, metadata !2312, metadata !2315, metadata !2318, metadata !2323, metadata !2327, metadata !2332, metadata !2336, metadata !2339, metadata !2343, metadata !2346, metadata !2347, metadata !2348, metadata !2351, metadata !2354, metadata !2357, metadata !2358, metadata !2359, metadata !2362, metadata !2365, metadata !2366, metadata !2369, metadata !2373, metadata !2376, metadata !2380, metadata !2381, metadata !2382, metadata !2383, metadata !2384, metadata !2387, metadata !2388, metadata !2391, metadata !2394, metadata !2397, metadata !2398, metadata !2399, metadata !2400}
...
!1985 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<unsigned long>", metadata !"_M_insert<unsigned long>", metadata !"_ZNSo9_M_insertImEERSoT_", metadata !1754, i32 367, metadata !1919, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1986, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!1986 = metadata !{metadata !1987}
!1987 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !140, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1988 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<long long>", metadata !"_M_insert<long long>", metadata !"_ZNSo9_M_insertIxEERSoT_", metadata !1754, i32 367, metadata !1937, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1989, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!1989 = metadata !{metadata !1990}
!1990 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1053, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1991 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<double>", metadata !"_M_insert<double>", metadata !"_ZNSo9_M_insertIdEERSoT_", metadata !1754, i32 367, metadata !1943, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1992, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!1992 = metadata !{metadata !1993}
!1993 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1066, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1994 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<bool>", metadata !"_M_insert<bool>", metadata !"_ZNSo9_M_insertIbEERSoT_", metadata !1754, i32 367, metadata !1922, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1995, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!1995 = metadata !{metadata !1996}
!1996 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !238, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1997 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<long double>", metadata !"_M_insert<long double>", metadata !"_ZNSo9_M_insertIeEERSoT_", metadata !1754, i32 367, metadata !1949, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1998, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!1998 = metadata !{metadata !1999}
!1999 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1951, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2000 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<const void *>", metadata !"_M_insert<const void *>", metadata !"_ZNSo9_M_insertIPKvEERSoT_", metadata !1754, i32 367, metadata !1953, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2001, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!2001 = metadata !{metadata !2002}
!2002 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !351, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2005 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1058, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2006 = metadata !{i32 786478, i32 0, metadata !1748, metadata !"_M_insert<long>", metadata !"_M_insert<long>", metadata !"_ZNSo9_M_insertIlEERSoT_", metadata !1754, i32 367, metadata !1916, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2007, i32 0, metadata !89, i32 367} ; [ DW_TAG_subprogram ]
!2007 = metadata !{metadata !2008}
!2008 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !64, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2381 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<unsigned long>", metadata !"_M_extract<unsigned long>", metadata !"_ZNSi10_M_extractImEERSiRT_", metadata !2246, i32 592, metadata !2295, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1986, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2382 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<long long>", metadata !"_M_extract<long long>", metadata !"_ZNSi10_M_extractIxEERSiRT_", metadata !2246, i32 592, metadata !2298, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1989, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2383 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<double>", metadata !"_M_extract<double>", metadata !"_ZNSi10_M_extractIdEERSiRT_", metadata !2246, i32 592, metadata !2307, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1992, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2384 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<float>", metadata !"_M_extract<float>", metadata !"_ZNSi10_M_extractIfEERSiRT_", metadata !2246, i32 592, metadata !2304, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2385, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2385 = metadata !{metadata !2386}
!2386 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1062, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2387 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<bool>", metadata !"_M_extract<bool>", metadata !"_ZNSi10_M_extractIbEERSiRT_", metadata !2246, i32 592, metadata !2276, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1995, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2388 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<unsigned int>", metadata !"_M_extract<unsigned int>", metadata !"_ZNSi10_M_extractIjEERSiRT_", metadata !2246, i32 592, metadata !2289, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2389, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2389 = metadata !{metadata !2390}
!2390 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !914, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2391 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<void *>", metadata !"_M_extract<void *>", metadata !"_ZNSi10_M_extractIPvEERSiRT_", metadata !2246, i32 592, metadata !2313, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2392, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
!2392 = metadata !{metadata !2393}
!2393 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !101, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2396 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !165, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2397 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<long double>", metadata !"_M_extract<long double>", metadata !"_ZNSi10_M_extractIeEERSiRT_", metadata !2246, i32 592, metadata !2310, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1998, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
...
!2399 = metadata !{i32 786478, i32 0, metadata !1737, metadata !"_M_extract<long>", metadata !"_M_extract<long>", metadata !"_ZNSi10_M_extractIlEERSiRT_", metadata !2246, i32 592, metadata !2292, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2007, i32 0, metadata !89, i32 592} ; [ DW_TAG_subprogram ]
...
!3117 = metadata !{metadata !"kernel_arg_type", metadata !"hls::stream<char> &", metadata !"hls::stream<ap_out> &"}
...
!3122 = metadata !{metadata !"kernel_arg_type", metadata !"const struct ap_out &"}
...
!3137 = metadata !{i32 786689, metadata !906, metadata !"str", metadata !902, i32 16777252, metadata !213, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3138 = metadata !{i32 36, i32 23, metadata !906, null}
!3139 = metadata !{i32 786689, metadata !906, metadata !"hash", metadata !902, i32 33554468, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3140 = metadata !{i32 36, i32 38, metadata !906, null}
!3141 = metadata !{i32 36, i32 59, metadata !3142, null}
!3142 = metadata !{i32 786443, metadata !906, i32 36, i32 58, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3143 = metadata !{i32 36, i32 92, metadata !3142, null}
!3144 = metadata !{i32 41, i32 6, metadata !3145, null}
!3145 = metadata !{i32 786443, metadata !3142, i32 41, i32 2, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3146 = metadata !{i32 41, i32 24, metadata !3147, null}
!3147 = metadata !{i32 786443, metadata !3145, i32 41, i32 23, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3148 = metadata !{i32 42, i32 1, metadata !3147, null}
!3149 = metadata !{i32 43, i32 2, metadata !3147, null}
!3150 = metadata !{i32 786688, metadata !3142, metadata !"sum", metadata !902, i32 38, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3151 = metadata !{i32 44, i32 2, metadata !3147, null}
!3152 = metadata !{i32 41, i32 19, metadata !3145, null}
!3153 = metadata !{i32 786688, metadata !3142, metadata !"i", metadata !902, i32 37, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3154 = metadata !{i32 45, i32 2, metadata !3142, null}
!3155 = metadata !{i32 48, i32 6, metadata !3156, null}
!3156 = metadata !{i32 786443, metadata !3142, i32 48, i32 2, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!3157 = metadata !{i32 48, i32 30, metadata !3158, null}
!3158 = metadata !{i32 786443, metadata !3156, i32 48, i32 29, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!3159 = metadata !{i32 49, i32 1, metadata !3158, null}
!3160 = metadata !{i32 50, i32 1, metadata !3158, null}
!3161 = metadata !{i32 51, i32 2, metadata !3158, null}
!3162 = metadata !{i32 52, i32 3, metadata !3158, null}
!3163 = metadata !{i32 53, i32 2, metadata !3158, null}
!3164 = metadata !{i32 48, i32 25, metadata !3156, null}
!3165 = metadata !{i32 54, i32 1, metadata !3142, null}
!3166 = metadata !{i32 786689, metadata !910, metadata !"key", metadata !902, i32 16777317, metadata !213, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3167 = metadata !{i32 101, i32 29, metadata !910, null}
!3168 = metadata !{i32 786689, metadata !910, metadata !"len", metadata !902, i32 33554533, metadata !913, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3169 = metadata !{i32 101, i32 43, metadata !910, null}
!3170 = metadata !{i32 102, i32 1, metadata !3171, null}
!3171 = metadata !{i32 786443, metadata !910, i32 101, i32 63, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!3172 = metadata !{i32 786688, metadata !3171, metadata !"kValues", metadata !902, i32 105, metadata !3173, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3176 = metadata !{i32 105, i32 12, metadata !3171, null}
!3177 = metadata !{i32 110, i32 16, metadata !3178, null}
!3178 = metadata !{i32 786443, metadata !3171, i32 110, i32 3, metadata !902, i32 12} ; [ DW_TAG_lexical_block ]
!3179 = metadata !{i32 125, i32 17, metadata !3180, null}
!3180 = metadata !{i32 786443, metadata !3171, i32 125, i32 3, metadata !902, i32 14} ; [ DW_TAG_lexical_block ]
!3181 = metadata !{i32 110, i32 33, metadata !3182, null}
!3182 = metadata !{i32 786443, metadata !3178, i32 110, i32 32, metadata !902, i32 13} ; [ DW_TAG_lexical_block ]
!3183 = metadata !{i32 111, i32 1, metadata !3182, null}
!3184 = metadata !{i32 114, i32 1, metadata !3182, null}
!3185 = metadata !{i32 116, i32 81, metadata !3182, null}
!3186 = metadata !{i32 786688, metadata !3182, metadata !"k", metadata !902, i32 116, metadata !913, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3187 = metadata !{i32 117, i32 4, metadata !3182, null}
!3188 = metadata !{i32 118, i32 4, metadata !3182, null}
!3189 = metadata !{i32 119, i32 4, metadata !3182, null}
!3190 = metadata !{i32 110, i32 27, metadata !3178, null}
!3191 = metadata !{i32 786688, metadata !3171, metadata !"kItr", metadata !902, i32 106, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3192 = metadata !{i32 121, i32 4, metadata !3182, null}
!3193 = metadata !{i32 122, i32 3, metadata !3182, null}
!3194 = metadata !{i32 786688, metadata !3178, metadata !"i", metadata !902, i32 110, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3195 = metadata !{i32 125, i32 34, metadata !3196, null}
!3196 = metadata !{i32 786443, metadata !3180, i32 125, i32 33, metadata !902, i32 15} ; [ DW_TAG_lexical_block ]
!3197 = metadata !{i32 126, i32 1, metadata !3196, null}
!3198 = metadata !{i32 128, i32 1, metadata !3196, null}
!3199 = metadata !{i32 129, i32 2, metadata !3196, null}
!3200 = metadata !{i32 786688, metadata !3171, metadata !"hash", metadata !902, i32 103, metadata !913, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3201 = metadata !{i32 130, i32 4, metadata !3196, null}
!3202 = metadata !{i32 131, i32 4, metadata !3196, null}
!3203 = metadata !{i32 132, i32 3, metadata !3196, null}
!3204 = metadata !{i32 125, i32 29, metadata !3180, null}
!3205 = metadata !{i32 786688, metadata !3180, metadata !"i", metadata !902, i32 125, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3206 = metadata !{i32 137, i32 66, metadata !3171, null}
!3207 = metadata !{i32 786688, metadata !3171, metadata !"tail", metadata !902, i32 137, metadata !3208, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3211 = metadata !{i32 140, i32 3, metadata !3171, null}
!3212 = metadata !{i32 141, i32 13, metadata !3213, null}
!3213 = metadata !{i32 786443, metadata !3171, i32 140, i32 20, metadata !902, i32 16} ; [ DW_TAG_lexical_block ]
!3214 = metadata !{i32 786688, metadata !3171, metadata !"k", metadata !902, i32 138, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3215 = metadata !{i32 143, i32 13, metadata !3213, null}
!3216 = metadata !{i32 146, i32 7, metadata !3213, null}
!3217 = metadata !{i32 147, i32 7, metadata !3213, null}
!3218 = metadata !{i32 148, i32 7, metadata !3213, null}
!3219 = metadata !{i32 149, i32 7, metadata !3213, null}
!3220 = metadata !{i32 150, i32 7, metadata !3213, null}
!3221 = metadata !{i32 151, i32 3, metadata !3213, null}
!3222 = metadata !{i32 153, i32 3, metadata !3171, null}
!3223 = metadata !{i32 154, i32 3, metadata !3171, null}
!3224 = metadata !{i32 155, i32 3, metadata !3171, null}
!3225 = metadata !{i32 156, i32 3, metadata !3171, null}
!3226 = metadata !{i32 157, i32 3, metadata !3171, null}
!3227 = metadata !{i32 158, i32 3, metadata !3171, null}
!3228 = metadata !{i32 160, i32 3, metadata !3171, null}
!3229 = metadata !{i32 786689, metadata !901, metadata !"hash", metadata !902, i32 16777239, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3230 = metadata !{i32 23, i32 25, metadata !901, null}
!3231 = metadata !{i32 786689, metadata !901, metadata !"indices", metadata !902, i32 33554455, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3232 = metadata !{i32 23, i32 47, metadata !901, null}
!3233 = metadata !{i32 23, i32 59, metadata !3234, null}
!3234 = metadata !{i32 786443, metadata !901, i32 23, i32 58, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3235 = metadata !{i32 23, i32 93, metadata !3234, null}
!3236 = metadata !{i32 26, i32 6, metadata !3237, null}
!3237 = metadata !{i32 786443, metadata !3234, i32 26, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3238 = metadata !{i32 26, i32 24, metadata !3239, null}
!3239 = metadata !{i32 786443, metadata !3237, i32 26, i32 23, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3240 = metadata !{i32 27, i32 1, metadata !3239, null}
!3241 = metadata !{i32 28, i32 6, metadata !3242, null}
!3242 = metadata !{i32 786443, metadata !3239, i32 28, i32 2, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3243 = metadata !{i32 28, i32 21, metadata !3244, null}
!3244 = metadata !{i32 786443, metadata !3242, i32 28, i32 20, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3245 = metadata !{i32 29, i32 1, metadata !3244, null}
!3246 = metadata !{i32 30, i32 27, metadata !3244, null}
!3247 = metadata !{i32 786688, metadata !3244, metadata !"offset", metadata !902, i32 30, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3248 = metadata !{i32 31, i32 4, metadata !3244, null}
!3249 = metadata !{i32 31, i32 36, metadata !3244, null}
!3250 = metadata !{i32 32, i32 3, metadata !3244, null}
!3251 = metadata !{i32 28, i32 16, metadata !3242, null}
!3252 = metadata !{i32 786688, metadata !3234, metadata !"j", metadata !902, i32 24, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3253 = metadata !{i32 33, i32 2, metadata !3239, null}
!3254 = metadata !{i32 26, i32 19, metadata !3237, null}
!3255 = metadata !{i32 786688, metadata !3234, metadata !"i", metadata !902, i32 24, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3256 = metadata !{i32 34, i32 1, metadata !3234, null}
!3257 = metadata !{i32 786689, metadata !915, metadata !"inputData", metadata !902, i32 16777379, metadata !918, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3258 = metadata !{i32 163, i32 37, metadata !915, null}
!3259 = metadata !{i32 786689, metadata !915, metadata !"outputData", metadata !902, i32 33554595, metadata !966, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3260 = metadata !{i32 163, i32 69, metadata !915, null}
!3261 = metadata !{i32 164, i32 1, metadata !3262, null}
!3262 = metadata !{i32 786443, metadata !915, i32 163, i32 81, metadata !902, i32 17} ; [ DW_TAG_lexical_block ]
!3263 = metadata !{i32 165, i32 1, metadata !3262, null}
!3264 = metadata !{i32 166, i32 1, metadata !3262, null}
!3265 = metadata !{i32 786688, metadata !3262, metadata !"buffer", metadata !902, i32 168, metadata !3266, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3269 = metadata !{i32 168, i32 7, metadata !3262, null}
!3270 = metadata !{i32 169, i32 1, metadata !3262, null}
!3271 = metadata !{i32 170, i32 1, metadata !3262, null}
!3272 = metadata !{i32 786688, metadata !3262, metadata !"indices", metadata !902, i32 171, metadata !3273, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3276 = metadata !{i32 171, i32 6, metadata !3262, null}
!3277 = metadata !{i32 172, i32 2, metadata !3262, null}
...
!3280 = metadata !{i32 178, i32 14, metadata !3281, null}
!3281 = metadata !{i32 786443, metadata !3282, i32 176, i32 27, metadata !902, i32 19} ; [ DW_TAG_lexical_block ]
!3282 = metadata !{i32 786443, metadata !3262, i32 176, i32 2, metadata !902, i32 18} ; [ DW_TAG_lexical_block ]
!3283 = metadata !{i32 176, i32 13, metadata !3282, null}
!3284 = metadata !{i32 176, i32 28, metadata !3281, null}
!3285 = metadata !{i32 177, i32 1, metadata !3281, null}
...
!3292 = metadata !{i32 179, i32 2, metadata !3281, null}
!3293 = metadata !{i32 176, i32 23, metadata !3282, null}
!3294 = metadata !{i32 786688, metadata !3282, metadata !"i", metadata !902, i32 176, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3295 = metadata !{i32 184, i32 2, metadata !3262, null}
!3296 = metadata !{i32 203, i32 4, metadata !3297, null}
!3297 = metadata !{i32 786443, metadata !3298, i32 202, i32 8, metadata !902, i32 23} ; [ DW_TAG_lexical_block ]
!3298 = metadata !{i32 786443, metadata !3299, i32 191, i32 28, metadata !902, i32 21} ; [ DW_TAG_lexical_block ]
!3299 = metadata !{i32 786443, metadata !3262, i32 191, i32 2, metadata !902, i32 20} ; [ DW_TAG_lexical_block ]
!3300 = metadata !{i32 205, i32 3, metadata !3298, null}
...
!3303 = metadata !{i32 206, i32 3, metadata !3298, null}
...
!3306 = metadata !{i32 207, i32 3, metadata !3298, null}
!3307 = metadata !{i32 146, i32 9, metadata !3305, metadata !3306}
!3308 = metadata !{i32 191, i32 15, metadata !3299, null}
!3309 = metadata !{i32 786688, metadata !3298, metadata !"item", metadata !902, i32 196, metadata !970, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3310 = metadata !{i32 196, i32 17, metadata !3298, null}
!3311 = metadata !{i32 786689, metadata !1384, metadata !"this", metadata !902, i32 16777229, metadata !3312, i32 64, metadata !3313} ; [ DW_TAG_arg_variable ]
!3312 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !970} ; [ DW_TAG_pointer_type ]
!3313 = metadata !{i32 196, i32 21, metadata !3298, null}
!3314 = metadata !{i32 13, i32 8, metadata !1384, metadata !3313}
!3315 = metadata !{i32 786689, metadata !1385, metadata !"this", metadata !902, i32 16777229, metadata !3312, i32 64, metadata !3314} ; [ DW_TAG_arg_variable ]
!3316 = metadata !{i32 13, i32 8, metadata !1385, metadata !3314}
!3317 = metadata !{i32 198, i32 3, metadata !3298, null}
!3318 = metadata !{i32 199, i32 4, metadata !3319, null}
!3319 = metadata !{i32 786443, metadata !3298, i32 198, i32 22, metadata !902, i32 22} ; [ DW_TAG_lexical_block ]
!3320 = metadata !{i32 786688, metadata !3262, metadata !"dataLen", metadata !902, i32 190, metadata !914, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3321 = metadata !{i32 200, i32 25, metadata !3319, null}
!3322 = metadata !{i32 201, i32 4, metadata !3319, null}
!3323 = metadata !{i32 786688, metadata !3262, metadata !"lastIndex", metadata !902, i32 189, metadata !914, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3324 = metadata !{i32 202, i32 3, metadata !3319, null}
...
!3332 = metadata !{i32 191, i32 24, metadata !3299, null}
!3333 = metadata !{i32 786688, metadata !3299, metadata !"i", metadata !902, i32 191, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3334 = metadata !{i32 210, i32 1, metadata !3262, null}
!3335 = metadata !{i32 786689, metadata !909, metadata !"str", metadata !902, i32 16777295, metadata !213, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3336 = metadata !{i32 79, i32 20, metadata !909, null}
!3337 = metadata !{i32 786689, metadata !909, metadata !"indices", metadata !902, i32 33554511, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3338 = metadata !{i32 79, i32 35, metadata !909, null}
!3339 = metadata !{i32 79, i32 47, metadata !3340, null}
!3340 = metadata !{i32 786443, metadata !909, i32 79, i32 46, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!3341 = metadata !{i32 79, i32 80, metadata !3340, null}
!3342 = metadata !{i32 786688, metadata !3340, metadata !"hash", metadata !902, i32 81, metadata !3343, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3346 = metadata !{i32 81, i32 6, metadata !3340, null}
!3347 = metadata !{i32 82, i32 1, metadata !3340, null}
!3348 = metadata !{i32 83, i32 1, metadata !3340, null}
!3349 = metadata !{i32 86, i32 2, metadata !3340, null}
!3350 = metadata !{i32 89, i32 2, metadata !3340, null}
!3351 = metadata !{i32 91, i32 1, metadata !3340, null}
