...
HLS_SOURCES = ../../adder_test.cpp ../../adder.cpp
...
$(ObjDir)/adder_test.o: ../../adder_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../adder_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD  $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/adder_test.d
