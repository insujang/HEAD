...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.calcHash.autotvin_strStream_V.dat"
         "c.calcHash.autotvin_indicesStream_V.dat"
         "c.calcHash.autotvout_indicesStream_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.calcHash.autotvout_indicesStream_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
