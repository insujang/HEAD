...
if {[file isfile calcHash.autotvin.dat]} {
	file delete -force calcHash.autotvin.dat
}

if {[file isfile calcHash.autotvout.dat]} {
	file delete -force calcHash.autotvout.dat
}
