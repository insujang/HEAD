...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calcHash.autotvin.dat"
	set constFileTvOut       "calcHash.autotvout.dat"
	set constFileHdlTvIn     "calcHash.autohdltvin.dat"
	set constFileHdlTvOut    "calcHash.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
